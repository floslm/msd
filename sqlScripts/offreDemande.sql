...
INSERT INTO `CritereDemandeur` VALUES (1,1,2),(1,2,3),(1,4,1),(3,5,10);
...
--
-- Table structure for table `CriteresDemandeur`
--

DROP TABLE IF EXISTS `CriteresDemandeur`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `CriteresDemandeur` (
  `idDemandeur` int(11) NOT NULL,
  `idValeurType` int(11) NOT NULL,
  PRIMARY KEY (`idDemandeur`,`idValeurType`),
  KEY `fk_CriteresOffrant_10_idx` (`idDemandeur`),
  CONSTRAINT `fk_CriteresOffrant_10` FOREIGN KEY (`idDemandeur`) REFERENCES `Demandeur` (`idDemandeur`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `CriteresDemandeur`
--

LOCK TABLES `CriteresDemandeur` WRITE;
/*!40000 ALTER TABLE `CriteresDemandeur` DISABLE KEYS */;
/*!40000 ALTER TABLE `CriteresDemandeur` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `CriteresOffrant`
--

DROP TABLE IF EXISTS `CriteresOffrant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `CriteresOffrant` (
  `idOffrant` int(11) NOT NULL,
  `idValeurType` int(11) NOT NULL,
  PRIMARY KEY (`idOffrant`,`idValeurType`),
  KEY `fk_CriteresOffrant_1_idx` (`idOffrant`),
  CONSTRAINT `fk_CriteresOffrant_1` FOREIGN KEY (`idOffrant`) REFERENCES `Offrant` (`idOffrant`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `CriteresOffrant`
--

LOCK TABLES `CriteresOffrant` WRITE;
/*!40000 ALTER TABLE `CriteresOffrant` DISABLE KEYS */;
/*!40000 ALTER TABLE `CriteresOffrant` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `Demandeur` VALUES (1,'Pascal Info'),(2,'Safa eco'),(3,'chercheCivil');
...
INSERT INTO `Type` VALUES (1,'Java','',1),(2,'MySql','',1),(3,'Finance','',2),(4,'Compta','',2),(5,'Ouvrage d\'art','',3);
