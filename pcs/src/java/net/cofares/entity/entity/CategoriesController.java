...
import net.cofares.entity.sb.CategoriesFacade;
...
public class CategoriesController implements Serializable {
    ...
    @EJB
    private net.cofares.entity.sb.CategoriesFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Categories) getItems().getRowData();
    ...
    public static class CategoriesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Categories) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Categories.class.getName());
            }
        }
