...
import net.cofares.sb.TypeFacade;
...
public class TypeController implements Serializable {
    ...
    @EJB
    private net.cofares.sb.TypeFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("TypeCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("TypeUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("TypeDeleted"));
        if (!JsfUtil.isValidationFailed()) {
